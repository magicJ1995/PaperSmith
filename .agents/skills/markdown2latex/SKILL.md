---
name: markdown2latex
description: Use when paper.md is mature and the user wants LaTeX export guidance. Not suitable when: Do not claim final venue compliance without checking the user-provided template. File changes: no. Default output: outputs/markdown2latex_plan.md.
---
...
Plan conversion from paper.md to LaTeX using local templates and references.

## When to Use

Use when paper.md is mature and the user wants LaTeX export guidance.

## When Not to Use

Do not claim final venue compliance without checking the user-provided template.

## Inputs

paper.md, writingrules.md, references/, user template files
...
outputs/markdown2latex_plan.md
...
This is a Codex-compatible migration of the CoPaper-style markdown2latex skill. The original intent is preserved, but execution is local-file-driven and Markdown-based.
