...
description: Use when the user provides real comments and wants them structured for revision. Not suitable when: Do not label AI-generated suggestions as real human feedback. File changes: no. Default output: reviews/human_comments.md.
---
...
Organize human advisor, teacher, or reviewer comments into actionable Markdown feedback.

## When to Use

Use when the user provides real comments and wants them structured for revision.

## When Not to Use

Do not label AI-generated suggestions as real human feedback.

## Inputs

reviews/, notes/, paper.md, storyline.md
...
This is a Codex-compatible migration of the CoPaper-style human-comment-helper skill. The original intent is preserved, but execution is local-file-driven and Markdown-based.
