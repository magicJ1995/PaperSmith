---
name: mad-writer
description: Use only when the user explicitly asks for faster drafting and enough evidence exists. Not suitable when: Do not run autonomous full-paper writing or generate fake data, citations, or claims. File changes: conditional. Default output: reviews/mad_writer_plan.md or an approved paper.md edit.
---
...
Provide a controlled fast-drafting plan for low-risk sections using verified evidence only.

## When to Use

Use only when the user explicitly asks for faster drafting and enough evidence exists.

## When Not to Use

Do not run autonomous full-paper writing or generate fake data, citations, or claims.

## Inputs

PROJECT_CONTEXT.md, storyline.md, paper.md, references/, notes/, outputs/
...
reviews/mad_writer_plan.md or an approved paper.md edit
...
This is a Codex-compatible migration of the CoPaper-style mad-writer skill. The original intent is preserved, but execution is local-file-driven and Markdown-based.
