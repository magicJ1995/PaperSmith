---
name: copaper-manage
description: Use when the user asks about workflow progress, setup, artifact readiness, or project organization. Not suitable when: Do not use legacy command tooling, UI status panels, subagent routing, or hidden state. File changes: no. Default output: reviews/project_status.md or notes/project_management_notes.md.
---
...
Map legacy CoPaper-style project management requests to local Markdown project checks.

## When to Use

Use when the user asks about workflow progress, setup, artifact readiness, or project organization.

## When Not to Use

Do not use legacy command tooling, UI status panels, subagent routing, or hidden state.

## Inputs

AGENTS.md, PROJECT_CONTEXT.md, storyline.md, paper.md, reviews/, notes/, references/, outputs/
...
reviews/project_status.md or notes/project_management_notes.md
...
This is a Codex-compatible migration of the CoPaper-style copaper-manage skill. The original intent is preserved, but execution is local-file-driven and Markdown-based.
