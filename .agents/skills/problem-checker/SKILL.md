...
description: Use for storyline Problem or Introduction problem review. Not suitable when: Do not invent motivation evidence. File changes: no. Default output: reviews/problem_review.md.
---
...
Check whether the research problem is concrete, important, and evidence-backed.

## When to Use

Use for storyline Problem or Introduction problem review.

## When Not to Use

Do not invent motivation evidence.

## Inputs

PROJECT_CONTEXT.md, storyline.md, paper.md, references/, notes/
...
This is a Codex-compatible migration of the CoPaper-style problem-checker skill. The original intent is preserved, but execution is local-file-driven and Markdown-based.
