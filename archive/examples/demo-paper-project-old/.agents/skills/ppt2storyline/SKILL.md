---
name: ppt2storyline
description: Use when the user provides slide text or a readable deck and wants storyline bootstrapping. Not suitable when: Do not invent claims from slide titles or guess missing slide content. File changes: conditional. Default output: notes/ppt_storyline_map.md and an edit plan for storyline.md.
---
...
Map user-provided slide deck content into storyline.md sections.

## When to Use

Use when the user provides slide text or a readable deck and wants storyline bootstrapping.

## When Not to Use

Do not invent claims from slide titles or guess missing slide content.

## Inputs

user-provided PPT/PPTX or extracted slide text, storyline.md
...
notes/ppt_storyline_map.md and an edit plan for storyline.md
...
- May modify storyline.md: Only after an edit plan and explicit user confirmation.
...
This is a Codex-compatible migration of the CoPaper-style ppt2storyline skill. The original intent is preserved, but execution is local-file-driven and Markdown-based.
