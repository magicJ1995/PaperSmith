---
name: auto-init
description: Use when the user wants to start a new paper project, verify setup, or recover missing template folders. Not suitable when: Do not use for drafting paper content or creating hidden workflow state. File changes: no. Default output: reviews/setup_check.md or notes/setup_notes.md.
---
...
Initialize or inspect a paper project setup from local files.

## When to Use

Use when the user wants to start a new paper project, verify setup, or recover missing template folders.

## When Not to Use

Do not use for drafting paper content or creating hidden workflow state.

## Inputs

AGENTS.md, PROJECT_CONTEXT.md, templates/paper-project, .agents/skills
...
reviews/setup_check.md or notes/setup_notes.md
...
This is a Codex-compatible migration of the CoPaper-style auto-init skill. The original intent is preserved, but execution is local-file-driven and Markdown-based.
