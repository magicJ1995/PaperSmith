...
description: Use for clarity review of paper.md, storyline.md, or a specific section. Not suitable when: Do not rewrite the draft directly during review-only tasks. File changes: no. Default output: reviews/clarity_review.md.
---
...
Check drafts for unclear terms, vague phrasing, undefined concepts, and readability issues.

## When to Use

Use for clarity review of paper.md, storyline.md, or a specific section.

## When Not to Use

Do not rewrite the draft directly during review-only tasks.

## Inputs

PROJECT_CONTEXT.md, storyline.md, paper.md, writingrules.md
...
This is a Codex-compatible migration of the CoPaper-style clarity-checker skill. The original intent is preserved, but execution is local-file-driven and Markdown-based.
