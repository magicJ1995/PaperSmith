...
description: Use when the user asks what to do next in the paper workflow. Not suitable when: Do not use hidden phase state or legacy workflow commands. File changes: no. Default output: notes/next_steps.md.
---
...
Translate phase-navigation requests into local artifact-oriented next steps.

## When to Use

Use when the user asks what to do next in the paper workflow.

## When Not to Use

Do not use hidden phase state or legacy workflow commands.
...
This is a Codex-compatible migration of the CoPaper-style phase-navigation skill. The original intent is preserved, but execution is local-file-driven and Markdown-based.
