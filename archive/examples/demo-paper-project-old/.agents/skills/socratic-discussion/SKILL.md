...
description: Use before drafting or when claims need stress-testing. Not suitable when: Do not answer by inventing research content; ask questions and record uncertainties. File changes: no. Default output: notes/socratic_discussion.md.
---
...
Run structured critical questions about problem, insight, method, evidence, and limitations.

## When to Use

Use before drafting or when claims need stress-testing.

## When Not to Use

Do not answer by inventing research content; ask questions and record uncertainties.
...
This is a Codex-compatible migration of the CoPaper-style socratic-discussion skill. The original intent is preserved, but execution is local-file-driven and Markdown-based.
