...
description: Use when the user asks what result tables or figures should contain before real results exist. Not suitable when: Do not generate fake numbers, fake trends, synthetic baselines, or publishable placeholder results. File changes: no. Default output: notes/result_table_plan.md or reviews/data_gap_report.md.
---
...
Design placeholder-free result table plans and identify missing experimental evidence.

## When to Use

Use when the user asks what result tables or figures should contain before real results exist.

## When Not to Use

Do not generate fake numbers, fake trends, synthetic baselines, or publishable placeholder results.

## Inputs

PROJECT_CONTEXT.md, storyline.md, paper.md, notes/, outputs/
...
notes/result_table_plan.md or reviews/data_gap_report.md
...
This is a Codex-compatible migration of the CoPaper-style bogus-data-helper skill. The original intent is preserved, but execution is local-file-driven and Markdown-based.
