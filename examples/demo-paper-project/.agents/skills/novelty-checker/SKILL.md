...
description: Use when reviewing insight, introduction, related work, or contribution claims. Not suitable when: Do not declare novelty without verified references. File changes: no. Default output: reviews/novelty_review.md.
---
...
Check whether novelty claims are specific, bounded, and supported by related work.

## When to Use

Use when reviewing insight, introduction, related work, or contribution claims.

## When Not to Use

Do not declare novelty without verified references.

## Inputs

PROJECT_CONTEXT.md, storyline.md, paper.md, references/
...
This is a Codex-compatible migration of the CoPaper-style novelty-checker skill. The original intent is preserved, but execution is local-file-driven and Markdown-based.
