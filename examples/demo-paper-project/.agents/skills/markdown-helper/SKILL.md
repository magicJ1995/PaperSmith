...
description: Use for section-by-section paper.md writing based on verified project files. Not suitable when: Do not draft when evidence inventory is insufficient. File changes: conditional. Default output: reviews/section_draft_plan.md or approved edits to paper.md.
---
...
Draft or polish Markdown paper sections with user confirmation.

## When to Use

Use for section-by-section paper.md writing based on verified project files.

## When Not to Use

Do not draft when evidence inventory is insufficient.
...
reviews/section_draft_plan.md or approved edits to paper.md
...
This is a Codex-compatible migration of the CoPaper-style markdown-helper skill. The original intent is preserved, but execution is local-file-driven and Markdown-based.
