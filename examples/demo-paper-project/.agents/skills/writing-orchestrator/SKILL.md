...
description: Use when the user wants help deciding what section to write next. Not suitable when: Do not silently start full-paper drafting or update hidden workflow state. File changes: no. Default output: reviews/writing_plan.md.
---
...
Coordinate section-by-section writing order, reviews, and revision gates.

## When to Use

Use when the user wants help deciding what section to write next.

## When Not to Use

Do not silently start full-paper drafting or update hidden workflow state.

## Inputs

PROJECT_CONTEXT.md, storyline.md, paper.md, reviews/
...
This is a Codex-compatible migration of the CoPaper-style writing-orchestrator skill. The original intent is preserved, but execution is local-file-driven and Markdown-based.
