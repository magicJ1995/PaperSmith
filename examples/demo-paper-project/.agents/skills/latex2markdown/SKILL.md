---
name: latex2markdown
description: Use when an existing LaTeX draft should be mapped into this workflow. Not suitable when: Do not infer missing content from LaTeX structure alone. File changes: conditional. Default output: notes/latex_import_map.md and an edit plan for paper.md.
---
...
Convert user-provided LaTeX draft content into the local paper.md structure.

## When to Use

Use when an existing LaTeX draft should be mapped into this workflow.

## When Not to Use

Do not infer missing content from LaTeX structure alone.

## Inputs

user-provided .tex files, paper.md, writingrules.md
...
notes/latex_import_map.md and an edit plan for paper.md
...
This is a Codex-compatible migration of the CoPaper-style latex2markdown skill. The original intent is preserved, but execution is local-file-driven and Markdown-based.
