...
description: Use when evaluation design or experiment section needs rigor checking. Not suitable when: Do not invent baselines, datasets, metrics, or result interpretations. File changes: no. Default output: reviews/evaluation_protocol_review.md.
---
...
Review research questions, datasets, baselines, metrics, and threats to validity.

## When to Use

Use when evaluation design or experiment section needs rigor checking.

## When Not to Use

Do not invent baselines, datasets, metrics, or result interpretations.
...
reviews/evaluation_protocol_review.md
...
This is a Codex-compatible migration of the CoPaper-style evaluation-protocol-checker skill. The original intent is preserved, but execution is local-file-driven and Markdown-based.
