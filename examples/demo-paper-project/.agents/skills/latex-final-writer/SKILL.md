...
description: Use after paper.md is stable and the user provides a LaTeX template. Not suitable when: Do not use before claims, citations, and experiments are verified. File changes: conditional. Default output: outputs/latex_plan.md and outputs/tex/.
---
...
Plan and draft a final LaTeX manuscript from a mature Markdown paper and a user-provided venue template.

## When to Use

Use after paper.md is stable and the user provides a LaTeX template.

## When Not to Use

Do not use before claims, citations, and experiments are verified.

## Inputs

paper.md, references/, outputs/, template files supplied by user
...
outputs/latex_plan.md and outputs/tex/
...
This is a Codex-compatible migration of the CoPaper-style latex-final-writer skill. The original intent is preserved, but execution is local-file-driven and Markdown-based.
